...
-- *****************************************************************************
-- Generated on "12/07/2020 15:20:05"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          selector2
-- 
...
ENTITY selector2_vhd_vec_tst IS
END selector2_vhd_vec_tst;
ARCHITECTURE selector2_arch OF selector2_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
